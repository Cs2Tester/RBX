--[[
    TurtleUiLib – Black & White Edition
    All UI elements converted to grayscale.
    Color picker remains functional and colorful.
]]
...
function library:Window(name) 
    ...
    UiWindow.BackgroundColor3 = Color3.fromRGB(30, 30, 30)        -- Dark gray window bar
    UiWindow.BorderColor3 = Color3.fromRGB(30, 30, 30)
    ...
    Header.BackgroundColor3 = Color3.fromRGB(45, 45, 45)          -- Slightly lighter header
    ...
    HeaderText.TextColor3 = Color3.fromRGB(255, 255, 255)         -- White text
    ...
    Minimise.BackgroundColor3 = Color3.fromRGB(45, 45, 45)        -- Same as header
    Minimise.BorderColor3 = Color3.fromRGB(45, 45, 45)
    ...
    Minimise.Text = "_"
    Minimise.TextColor3 = Color3.fromRGB(255, 255, 255)           -- White
    ...
    Window.BackgroundColor3 = Color3.fromRGB(60, 60, 60)          -- Main window background (medium gray)
    ...
    function functions:Button(name, callback)
        ...
        Button.BackgroundColor3 = Color3.fromRGB(75, 75, 75)      -- Lighter gray for buttons
        Button.BorderColor3 = Color3.fromRGB(150, 150, 150)       -- Light gray border
    ...
    function functions:Label(text, color)
        local color = color or Color3.fromRGB(220, 220, 220)      -- Light gray default
	    ...
	    spawn(function()
                while wait() do
                    local hue = tick() % 5 / 5
                    Label.TextColor3 = Color3.fromHSV(hue, 1, 1)  -- Rainbow effect
                end
	    end)
        else
    ...
    function functions:Toggle(text, on, callback)
        ...
        ToggleDescription.TextColor3 = Color3.fromRGB(255, 255, 255)  -- White
        ...
        ToggleButton.BackgroundColor3 = Color3.fromRGB(60, 60, 60)     -- Dark gray
        ToggleButton.BorderColor3 = Color3.fromRGB(150, 150, 150)      -- Light border
        ...
        ToggleFiller.BackgroundColor3 = Color3.fromRGB(255, 255, 255)  -- White indicator
        ToggleFiller.BorderColor3 = Color3.fromRGB(60, 60, 60)
    ...
    function functions:Box(text, callback)
        ...
        TextBox.BackgroundColor3 = Color3.fromRGB(75, 75, 75)          -- Lighter gray
        TextBox.BorderColor3 = Color3.fromRGB(150, 150, 150)           -- Light border
        ...
        BoxDescription.TextColor3 = Color3.fromRGB(255, 255, 255)      -- White
    ...
    function functions:Slider(text, min, max, default, callback)
        ...
        Slider.BackgroundColor3 = Color3.fromRGB(60, 60, 60)           -- Dark gray track
        Slider.BorderColor3 = Color3.fromRGB(150, 150, 150)            -- Light border
        ...
        SliderButton.BackgroundColor3 = Color3.fromRGB(100, 100, 100)  -- Medium gray thumb
        SliderButton.BorderColor3 = Color3.fromRGB(150, 150, 150)
        ...
        Current.TextColor3 = Color3.fromRGB(255, 255, 255)             -- White
        ...
        Description.TextColor3 = Color3.fromRGB(255, 255, 255)         -- White
        Description.TextSize = 16.000
        Description.ZIndex = 2 + zindex

        SilderFiller.Name = "SilderFiller"
        SilderFiller.Parent = Slider
        SilderFiller.BackgroundColor3 = Color3.fromRGB(255, 255, 255)  -- White fill
        SilderFiller.BorderColor3 = Color3.fromRGB(60, 60, 60)
        ...
        Min.TextColor3 = Color3.fromRGB(200, 200, 200)                 -- Light gray
        Min.TextSize = 14.000
    ...
    function functions:Dropdown(text, buttons, callback, selective)
        ...
        Dropdown.BackgroundColor3 = Color3.fromRGB(75, 75, 75)          -- Lighter gray
        Dropdown.BorderColor3 = Color3.fromRGB(150, 150, 150)           -- Light border
        ...
        Dropdown.TextColor3 = Color3.fromRGB(255, 255, 255)             -- White
        ...
        DownSign.Text = "^"
        DownSign.TextColor3 = Color3.fromRGB(255, 255, 255)             -- White
        ...
        DropdownFrame.BackgroundColor3 = Color3.fromRGB(60, 60, 60)     -- Dark background
        ...
        function dropFunctions:Button(name)
            ...
            Button_2.BackgroundColor3 = Color3.fromRGB(75, 75, 75)      -- Lighter gray
            Button_2.BorderColor3 = Color3.fromRGB(150, 150, 150)       -- Light border
            Button_2.Position = UDim2.new(0, 6, 0, canvasSize + 1)
            Button_2.Size = UDim2.new(0, 170, 0, 26)
            Button_2.Selected = true
            Button_2.Font = Enum.Font.SourceSans
            Button_2.TextColor3 = Color3.fromRGB(255, 255, 255)         -- White
    ...
    function functions:ColorPicker(name, default, callback)
        ...
        PickerDescription.TextColor3 = Color3.fromRGB(255, 255, 255)    -- White
        ...
        ColorPickerFrame.BackgroundColor3 = Color3.fromRGB(45, 45, 45)   -- Dark gray frame
        ColorPickerFrame.BorderColor3 = Color3.fromRGB(45, 45, 45)
        ...
        ToggleRGB.BackgroundColor3 = Color3.fromRGB(60, 60, 60)          -- Dark button
        ToggleRGB.BorderColor3 = Color3.fromRGB(150, 150, 150)           -- Light border
        ...
        ToggleFiller_2.BackgroundColor3 = Color3.fromRGB(255, 255, 255)  -- White indicator
        ToggleFiller_2.BorderColor3 = Color3.fromRGB(45, 45, 45)
        ...
        ClosePicker.BackgroundColor3 = Color3.fromRGB(45, 45, 45)        -- Dark
        ClosePicker.BorderColor3 = Color3.fromRGB(45, 45, 45)
        ClosePicker.Position = UDim2.new(0, 132, 0, 5)
        ClosePicker.Size = UDim2.new(0, 21, 0, 21)
        ClosePicker.Font = Enum.Font.SourceSans
        ClosePicker.Text = "X"
        ClosePicker.TextColor3 = Color3.fromRGB(255, 255, 255)           -- White
        ...
        if default and type(default) == "boolean" then
            ...
            ColorPicker.BackgroundColor3 = default or Color3.fromRGB(255, 255, 255)  -- Default white
        end
        ...
        ColorSlider.BackgroundColor3 = Color3.fromRGB(255, 255, 255)    -- White slider indicator
