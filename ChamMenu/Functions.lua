...
local function createFOVCircle()
    ...
    fovCircle.Size = UDim2.new(0, FOV.Radius * 2, 0, FOV.Radius * 2)
    fovCircle.Position = UDim2.new(0.5, -FOV.Radius, 0.5, -FOV.Radius)
    ...
    stroke.Color = FOV.Color
    stroke.Thickness = 2
    stroke.Parent = fovCircle
    
    fovCircle.Visible = FOV.Visible and FOV.Enabled
    ...
    if FOV.Enabled then
        if not fovCircle then
            ...
            if fovCircle:FindFirstChildOfClass("UIStroke") then
                fovCircle:FindFirstChildOfClass("UIStroke").Color = FOV.Color
            end
